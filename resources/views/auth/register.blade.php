...
<head>
    ...
    <title>Register Page - Rent your favourite car</title>
    <!-- Simple bar CSS -->
        ...
        <div class="row align-items-center h-100 ">
            <div class="col-lg-3 col-md-4 col-10 mx-auto text-center">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <h1 class="h6 mb-3">Mendaftar</h1>
                    <div class="form-group">
                        <label for="inputName" class="sr-only">Nama Lengkap</label>
                        <input type="name" id="inputName" name="name" class="form-control form-control-lg"
                    ...
                    <div class="form-group">
                        <label for="password-confirm" class="sr-only">Ulangi Password</label>
